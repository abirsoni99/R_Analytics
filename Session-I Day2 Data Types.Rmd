...
x <- list(1, "BITS", FALSE, 10-9i) # Is this a list or vector?
...
### Dataframes
```{r}
x <- data.frame(letters1 = letters[11:20], num1 = 1:10, num2 = 11:20)
x
class(x)
typeof(x)
length(x)
...
v == w # Compare two vectors with different sizes FTTF? does in pair of 2 
